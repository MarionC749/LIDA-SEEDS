...
def create_user_guide_layout():
     return html.Div(
         ...
         children=[
            ...
            html.H4("Data Layer Guidance"),
            html.P("Please note that the data layers have been sourced from external datasets and were not collected or generated by the SEEDS team."),
            html.P(["Have a resource or suggestion to share? If you think we have missed an important data layer or resource, please get in touch with our SEEDS team ",
                html.A(
                "here",
